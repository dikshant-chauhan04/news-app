  ...
  return (
    <div>
          <div className="card my-3">
           <img src={props.imageUrl} className="card-img-top" alt="article" style={{height: "200px"}}/>
           ...
           <div className="card-body">
             <h5 className="card-title" style={{height: "50px", overflow: "hidden"}}>{props.title}</h5>
             <p className="card-text" style={{height: "100px",overflow: "hidden" }}>{props.description}</p>
